                  ...
                  <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      ...
                      <td style="padding-left:14px;">
                        <div style="font-family:Georgia,'Times New Roman',serif;font-size:17px;font-weight:700;color:#ffffff;line-height:1.2;letter-spacing:0.2px;">PULSO UGEL</div>
                        <div style="font-size:10px;color:#d4a843;letter-spacing:1px;text-transform:uppercase;margin-top:2px;">Sistema Institucional &bull; UGEL Huacaybamba</div>
                      </td>
                    </tr>
                  </table>
                </td>
        ...
        <tr>
          <td style="background-color:#ffffff;padding:36px 40px;">
            ...
            <p style="font-size:14px;color:#445573;line-height:1.7;margin:0;">
              ...
              @else
                Atentamente,<br>
                <strong style="color:#0d1b3e;">{{ config('app.name') }}</strong>
              @endif
            </p>
