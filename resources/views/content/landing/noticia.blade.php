...
@section('page-style')
  ...
  <style>
    /* ══ Reset de página ══ */
    .npage { background:#F1F5F9; min-height:100vh; overflow-x:hidden; }
    ...
    .npage .ugel-footer-new { border-radius: 16px; margin: 2rem auto; }
    .npage .ugel-topbar { border-radius: 0; }
    @media(max-width:991px){
      .npage .ugel-topbar,
      .npage .ugel-nav,
      .npage .ugel-footer-new { width:96%; }
    }
    @media(max-width:767px){
      .npage .ugel-topbar,
      .npage .ugel-nav,
      .npage .ugel-footer-new { width:100%; border-radius:0 !important; margin-left:0 !important; margin-right:0 !important; }
      .npage .ugel-footer-new { margin:0 !important; border-radius:0 !important; }
    }
    @media(max-width:480px){
      .npage .ugel-topbar { display:none; }
    }
    ...
    .npage-hero:hover .npage-hero__img { transform:scale(1.03); }
    .npage-hero__overlay {
      position:absolute; inset:0;
    ...
    /* ══ Layout principal ══ */
    .npage-layout { padding:2.5rem 0 4rem; }
    ...
    .npage-article__inner { padding:2rem 2.5rem 2.5rem; }
    ...
    .npage-meta__item {
      ...
      font-size:.76rem; color:#5B6F8A; font-weight:500;
    }
    .npage-meta__item svg { flex-shrink:0; }
    .npage-meta__item strong { color:#1340A0; }
    ...
    /* Contenido Quill */
    .npage-content { font-size:.95rem; line-height:1.9; color:#2D3E50; }
    .npage-content h2 { font-size:1.3rem; font-weight:800; color:#0D2554; margin:2rem 0 .75rem; padding-bottom:.4rem; border-bottom:2px solid #EFF6FF; }
    .npage-content h3 { font-size:1.1rem; font-weight:700; color:#1340A0; margin:1.5rem 0 .5rem; }
    .npage-content h4 { font-size:.95rem; font-weight:700; color:#1A52C4; margin:1.25rem 0 .4rem; }
    .npage-content p  { margin-bottom:1.1rem; }
    .npage-content ul, .npage-content ol { padding-left:1.5rem; margin-bottom:1.2rem; }
    .npage-content li { margin-bottom:.4rem; }
    .npage-content blockquote {
      margin:1.5rem 0; padding:1rem 1.5rem;
      background:#F0F7FF; border-left:4px solid #1340A0;
      border-radius:0 10px 10px 0;
      font-style:italic; color:#1340A0; font-size:.95rem;
    }
    .npage-content code { background:#F1F5F9; padding:.15em .4em; border-radius:4px; font-size:.85em; color:#C7253E; }
    .npage-content pre  { background:#0F172A; color:#E2E8F0; padding:1.25rem; border-radius:8px; overflow-x:auto; margin:1.25rem 0; }
    .npage-content pre code { color:inherit; background:none; padding:0; }
    .npage-content a    { color:#1340A0; text-decoration:underline dotted; }
    .npage-content a:hover { text-decoration:underline; }
    .npage-content img  { max-width:100%; border-radius:10px; margin:1rem 0; box-shadow:0 4px 20px rgba(0,0,0,.1); }
    .npage-content table { width:100%; border-collapse:collapse; margin:1.25rem 0; font-size:.88rem; }
    .npage-content th   { background:#1340A0; color:#fff; padding:.6rem .9rem; text-align:left; font-weight:600; }
    .npage-content td   { padding:.55rem .9rem; border-bottom:1px solid #E8EDF5; }
    .npage-content tr:nth-child(even) td { background:#F8FAFF; }
    ...
    .npage-share-btn {
      ...
      font-size:.75rem; font-weight:600; color:#1340A0;
      cursor:pointer; transition:all .2s;
    }
    .npage-share-btn:hover { background:#DBEAFE; }

    /* ══ Sidebar ══ */
    .npage-sidebar { position:sticky; top:82px; }
    .npage-card {
      background:#fff;
      border-radius:12px;
    ...
    .npage-card__body { padding:1rem 1.2rem; }
    ...
    .npage-cta__body { position:relative; z-index:1; }
    .npage-cta h5 { font-size:.9rem; font-weight:800; color:#fff; margin-bottom:.4rem; line-height:1.3; }
    .npage-cta p  { font-size:.76rem; color:rgba(255,255,255,.65); margin-bottom:1rem; }
    ...
    .nrel:last-child { border-bottom:none; padding-bottom:0; }
    .nrel:hover { opacity:.75; }
    .nrel__thumb {
      width:70px; height:52px; flex-shrink:0;
      border-radius:6px; overflow:hidden;
    }
    .nrel__thumb-inner { width:100%; height:100%; object-fit:cover; display:block; }
    .nrel__info { flex:1; min-width:0; }
    .nrel__meta { font-size:.64rem; color:#94A3B8; margin-bottom:.2rem; }
    .nrel__title { font-size:.76rem; font-weight:700; color:#2D3E50; line-height:1.35; }
    ...
    .npage-breadcrumb li { display:flex; align-items:center; gap:.3rem; }
    .npage-breadcrumb li + li::before { content:'/'; color:rgba(255,255,255,.3); }
    .npage-breadcrumb a { color:rgba(255,255,255,.5); text-decoration:none; }
    .npage-breadcrumb a:hover { color:rgba(255,255,255,.8); }
    .npage-breadcrumb .active { color:rgba(255,255,255,.8); }

    /* ══ RESPONSIVE ══ */
    @media(max-width:991px){
      .npage-sidebar { position:static; top:auto; }
      .npage-layout { padding:1.75rem 0 3rem; }
    }
    @media(max-width:767px){
      .npage-hero { min-height:260px; }
      .npage-hero__body { padding-bottom:2rem; }
      .npage-article__inner { padding:1.1rem; }
      .npage-lead { font-size:.92rem; padding:1rem 1.1rem; }
      .npage-meta { gap:.6rem; }
      /* Hero meta row: ocultar separador vertical y flex-wrap ya activo */
      .npage-hero__body [style*="width:1px"] { display:none !important; }
      /* Acciones bottom */
      .npage-actions { flex-direction:column; align-items:flex-start; }
      /* CTA card con enlace */
    ...
    @media(max-width:575px){
      .npage-hero { min-height:220px; }
      /* Nav: ocultar btn "Ingresar al Sistema" en mobile, dejar solo "Volver" */
      .npage-nav-login { display:none !important; }
      /* Article content: tablas con scroll horizontal */
      .npage-content { overflow-x:auto; }
      .npage-content table { min-width:480px; }
      .npage-content__table-wrap { overflow-x:auto; -webkit-overflow-scrolling:touch; }
      /* Shared: botones full width */
      .npage-share-btn { width:100%; justify-content:center; }
      /* Layout padding */
      .npage-layout { padding:1rem 0 2.5rem; }
    }
    @media(max-width:480px){
      /* Topbar oculto */
      .ugel-topbar { display:none; }
      .npage-article__inner { padding:.9rem; }
      /* Hero breadcrumb: truncar */
      .npage-breadcrumb { font-size:.65rem; }
      .npage-breadcrumb .active { max-width:160px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; display:inline-block; }
    }
  </style>
@endsection
    ...
    <div class="ugel-nav__inner">
      <a href="{{ route('landing') }}" class="ugel-nav__brand">
        ...
        <div class="ugel-nav__brand-text">
          ...
          <span class="ugel-nav__brand-sub">{{ $config?->nombre_institucion ?? 'Unidad de Gestión Educativa Local' }}{{ $config?->region ? ' · ' . $config->region : ' · Huánuco' }}</span>
        </div>
      </a>
...
<div class="npage-hero">
  <div class="npage-hero__img"
       style="@if($noticia->imagen_url)
                background-image:url('{{ $noticia->imagen_url }}');
              @else
  ...
  <div class="npage-hero__body">
    <div class="container">
      ...
      <span class="npage-badge" style="background:rgba(255,255,255,.12);color:#fff;border:1px solid rgba(255,255,255,.2);">
        {{ $noticia->etiqueta ?? ucfirst($noticia->tipo) }}
      </span>

      <h1 style="font-size:clamp(1.6rem,3.2vw,2.4rem);font-weight:900;color:#fff;line-height:1.18;max-width:780px;letter-spacing:-.03em;margin:.25rem 0 1.25rem;text-shadow:0 2px 12px rgba(0,0,0,.3);">
        {{ $noticia->titulo }}
      </h1>
      ...
      <div style="display:flex;flex-wrap:wrap;gap:1.5rem;align-items:center;">
        ...
        <div style="display:flex;align-items:center;gap:.6rem;">
          <div style="width:34px;height:34px;border-radius:50%;background:linear-gradient(135deg,#1340A0,#28c76f);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
          </div>
          <div>
            <div style="font-size:.7rem;color:rgba(255,255,255,.45);line-height:1.2;">Publicado por</div>
            <div style="font-size:.8rem;color:#fff;font-weight:600;">{{ $noticia->autor ?? 'Oficina SCI — UGEL Huacaybamba' }}</div>
          </div>
        </div>

        <div style="width:1px;height:28px;background:rgba(255,255,255,.2);"></div>

        <div style="display:flex;align-items:center;gap:.4rem;font-size:.78rem;color:rgba(255,255,255,.65);">
        ...
        <span style="display:inline-flex;align-items:center;gap:.3rem;padding:.25rem .65rem;border-radius:12px;font-size:.7rem;font-weight:700;color:#fff;border:1px solid rgba(255,255,255,.25);background:rgba(255,255,255,.1);">
      ...
      <div class="col-lg-8">
        <article class="npage-article">
          ...
          <div class="npage-article__inner">
            ...
            <div style="margin-top:2rem;padding:1.5rem;background:#F0F7FF;border-radius:10px;border:1px solid #BFDBFE;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:1rem;">
              <div>
                <div style="font-size:.78rem;font-weight:700;color:#1340A0;">Enlace relacionado</div>
                <div style="font-size:.75rem;color:#5B6F8A;margin-top:.2rem;">{{ $noticia->url_accion }}</div>
              </div>
            ...
            <div class="npage-actions">
              <div style="display:flex;gap:.5rem;align-items:center;flex-wrap:wrap;">
                ...
                <button class="npage-share-btn" onclick="
                  ...
                  }).bind(event.currentTarget)}" type="button">
        ...
        <div class="d-lg-none mt-4">
          <h5 style="font-size:.78rem;font-weight:800;text-transform:uppercase;letter-spacing:.08em;color:#607080;margin-bottom:1rem;display:flex;align-items:center;gap:.5rem;">
            <span style="display:inline-block;width:3px;height:14px;background:#1340A0;border-radius:2px;"></span>
            Más publicaciones
          </h5>
          <div class="row g-3">
            @foreach($relacionadas as $rel)
            <div class="col-sm-4">
              <a href="{{ route('landing.noticia', $rel->id) }}" style="text-decoration:none;display:block;background:#fff;border-radius:10px;overflow:hidden;box-shadow:0 1px 12px rgba(0,0,0,.07);transition:transform .25s,box-shadow .25s;"
                ...
                <div style="height:100px;@if($rel->imagen_url)background-image:url('{{ $rel->imagen_url }}');background-size:cover;background-position:center;@else background:{{ $rel->color_gradiente ?? 'linear-gradient(135deg,#1340A0,#1A52C4)' }};@endif"></div>
                <div style="padding:.75rem;">
                  <div style="font-size:.63rem;color:#94A3B8;margin-bottom:.25rem;">{{ $rel->created_at->format('d M Y') }}</div>
                  <div style="font-size:.76rem;font-weight:700;color:#2D3E50;line-height:1.3;">{{ Str::limit($rel->titulo, 60) }}</div>
                </div>
              </a>
            </div>
            @endforeach
        ...
        <aside class="npage-sidebar">
          ...
          <div class="npage-card d-none d-lg-block">
            <div class="npage-card__head">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.8)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
            ...
            <div class="npage-card__body">
              ...
              <a href="{{ route('landing.noticia', $rel->id) }}" class="nrel">
                <div class="nrel__thumb">
                  @if($rel->imagen_url)
                    <img src="{{ $rel->imagen_url }}" alt="" class="nrel__thumb-inner">
                  @else
                    <div class="nrel__thumb-inner" style="background:{{ $rel->color_gradiente ?? 'linear-gradient(135deg,#1340A0,#1A52C4)' }};display:flex;align-items:center;justify-content:center;">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.5)" stroke-width="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                    </div>
                  @endif
                </div>
                <div class="nrel__info">
                  <div class="nrel__meta">{{ $rel->created_at->format('d M Y') }} · {{ ucfirst($rel->tipo) }}</div>
          ...
          <div class="npage-card" style="background:linear-gradient(135deg,#1340A0 0%,#1d52c4 100%);border:none;">
            <div style="padding:1.25rem 1.3rem;text-align:center;">
              <div style="width:44px;height:44px;border-radius:50%;background:rgba(255,255,255,.15);display:flex;align-items:center;justify-content:center;margin:0 auto .75rem;">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.9)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
              </div>
              <p style="color:rgba(255,255,255,.85);font-size:.82rem;line-height:1.5;margin:0 0 1rem;">
          ...
          <div class="npage-card">
            <div class="npage-card__head">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.8)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
            ...
            <div class="npage-card__body">
              <div style="font-size:.78rem;color:#5B6F8A;line-height:1.8;">
                ...
                <div style="display:flex;gap:.5rem;margin-bottom:.5rem;">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#1340A0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;margin-top:.15rem;"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                  Lun – Vie: 8:00 am – 6:00 pm
                </div>
                <div style="display:flex;gap:.5rem;">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#1340A0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;margin-top:.15rem;"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.27h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.91a16 16 0 0 0 6 6l.91-.91a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                  Sistema PULSO
                </div>
              </div>
            </div>
      ...
      <div class="ugel-footer-new__grid">
          ...
          <div class="ugel-fn-brand__data">
            ...
            @if($config?->telefono)
              <a href="tel:{{ $config->telefono }}" class="ugel-fn-data-item">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13 19.79 19.79 0 0 1 1.61 4.38 2 2 0 0 1 3.59 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 9.91a16 16 0 0 0 6 6l.92-.92a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                {{ $config->telefono }}
              </a>
            @endif
            @if($config?->sitio_web)
              <a href="{{ $config->sitio_web }}" target="_blank" rel="noopener noreferrer" class="ugel-fn-data-item">
        ...
        <div class="ugel-fn-col">
          ...
          <ul>
            ...
            <li><a href="{{ route('landing') }}#contacto"><span class="ugel-fn-link-ico"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg></span>Contacto</a></li>
        ...
        <div class="ugel-fn-col">
          ...
          <ul>
            @forelse($instituciones->take(6) as $inst)
              <li>
                <a href="{{ $inst->url_sitio ?? '#' }}" @if($inst->url_sitio) target="_blank" rel="noopener noreferrer" @endif>
        ...
        <div class="ugel-fn-col">
          <h6 class="ugel-fn-col__title"><span class="ugel-fn-col__title-ico"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></span>Institución</h6>
          <div class="ugel-fn-inst-data">
            @if($config?->ugel_codigo)
              <div class="ugel-fn-inst-row"><span>Cód. UGEL</span><strong>{{ $config->ugel_codigo }}</strong></div>
            @endif
            @if($config?->ubigeo)
              <div class="ugel-fn-inst-row"><span>Ubigeo</span><strong>{{ $config->ubigeo }}</strong></div>
            @endif
            <div class="ugel-fn-inst-row"><span>Región</span><strong>{{ $config?->region ?? 'Huánuco' }}</strong></div>
            <div class="ugel-fn-inst-row"><span>Sector</span><strong>Educación</strong></div>
            @if($config?->director)
              <div class="ugel-fn-inst-row"><span>Director</span><strong>{{ $config->director }}</strong></div>
            @endif
          </div>
        </div>
  ...
  <div class="ugel-footer-new__bottom">
    <div class="container">
      <div class="ugel-footer-new__bottom-inner">
        <span>© {{ date('Y') }} {{ $config?->sigla ?? 'UGEL Huacaybamba' }} {{ $config?->region ?? 'Huánuco' }}, Perú. Todos los derechos reservados.</span>
        <div class="ugel-footer-new__bottom-right">
          ...
          @if($config?->sitio_web)
            <a href="{{ $config->sitio_web }}" target="_blank" rel="noopener noreferrer">Portal Institucional</a>
          @endif
        </div>
      </div>
    </div>
